...
def render(sh):
    ...
    def render_order_list(df_subset, search_query, empty_msg):
        ...
        for index, row in df_subset.iterrows():
            ...
            img_html = ""
            if b64_batter:
                # Półprzezroczysty bejsbolista w tle (8% krycia dla idealnej czytelności tekstu)
            ...
            # Pojedynczy bilet (skompresowany kod HTML, korzystający z .status-badge z pliku CSS)
